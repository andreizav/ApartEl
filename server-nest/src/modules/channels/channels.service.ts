...
export class ChannelsService {
  ...
  async getMappings(tenantId: string) {
    // Performance optimization: Avoid fetching all PortfolioGroups and Units into memory.
    // Instead, query the exact ChannelMappings directly using relational filters.
  ...
  async updateMappings(tenantId: string, list: any[]) {
    ...
    // Performance optimization: Batch operations in a single transaction to reduce database round-trips.
  ...
  async getIcal(tenantId: string) {
    // Performance optimization: Avoid fetching all PortfolioGroups and Units into memory.
    // Instead, query the exact IcalConnections directly using relational filters.
