...
export class ChannelsService {
  ...
  async getMappings(tenantId: string) {
    // Bolt ⚡ Optimization: Querying channel mappings directly instead of
    // fetching the entire parent tree (portfolioGroup -> units -> channelMappings).
    // This minimizes database query size, memory overhead, and serialization costs.
  ...
  async getIcal(tenantId: string) {
    // Bolt ⚡ Optimization: Querying ical connections directly instead of
    // fetching the entire parent tree to minimize memory and parsing overhead.
