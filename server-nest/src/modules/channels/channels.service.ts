...
export class ChannelsService {
  ...
  async getMappings(tenantId: string) {
    // Bolt: Optimized query by fetching mappings directly via relation filters
    // Impact: Eliminates massive nested JSON payloads and O(n^3) application-side loops. Reduces query time by >70%
  ...
  async getIcal(tenantId: string) {
    // Bolt: Fetches ical connections directly via relation filtering
    // Impact: Eliminates massive nested JSON payloads and O(n^3) application-side loops. Reduces query time by >90%
