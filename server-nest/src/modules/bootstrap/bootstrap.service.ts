...
export class BootstrapService {
    ...
    async getBootstrapData(tenantId: string, user: any, tenant: any) {
        // ⚡ Bolt Optimization: Use Promise.all to fetch independent root entities concurrently
        const [
            groups,
            bookings,
            clients,
        ...
        // ⚡ Bolt Optimization: Replace N+1 nested loop queries with bulk IN queries
