...
export class BootstrapService {
    ...
    async getBootstrapData(tenantId: string, user: any, tenant: any) {
        // ⚡ Bolt Optimization: Fetch all independent root entities concurrently to minimize database round-trip latency
        const [
            groups,
            bookings,
            clients,
        ...
        // ⚡ Bolt Optimization: Resolve N+1 query problem by batching fetching
