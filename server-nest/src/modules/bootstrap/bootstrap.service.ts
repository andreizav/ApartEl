...
export class BootstrapService {
    ...
    async getBootstrapData(tenantId: string, user: any, tenant: any) {
        // Performance optimization: Fetch root entities concurrently using Promise.all
        const [
            groups,
            bookings,
            clients,
        ...
        // Performance optimization: Batch channel mappings and ical connections to avoid N+1 queries
