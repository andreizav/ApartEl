...
export class BootstrapService {
    ...
    async getBootstrapData(tenantId: string, user: any, tenant: any) {
        ...
        // ⚡ Bolt Optimization: Batch queries to prevent N+1 query loops.
        // Expected impact: Removes N*2 queries per portfolio group initialization, dropping startup latency by >95% for tenants with large portfolios.
