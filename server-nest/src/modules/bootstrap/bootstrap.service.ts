...
export class BootstrapService {
  ...
  async getBootstrapData(tenantId: string, user: any, tenant: any) {
    // Fetch all independent root entities concurrently to minimize database round-trip times
    const [
      groups,
      bookings,
      clients,
    ...
    // Get channel mappings and ical connections from units efficiently
    // Extracted unitIds and using 'in' operator to resolve N+1 queries.
