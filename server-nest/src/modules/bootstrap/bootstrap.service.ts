...
export class BootstrapService {
    ...
    async getBootstrapData(tenantId: string, user: any, tenant: any) {
        // ⚡ Bolt: Fetch all root entities concurrently using Promise.all to minimize DB round-trips
        ...
        // ⚡ Bolt: Resolve N+1 query issue for fetching mappings and connections
        // Extract all unit IDs and execute bulk queries concurrently
