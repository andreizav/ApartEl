...
export class BootstrapService {
    ...
    async getBootstrapData(tenantId: string, user: any, tenant: any) {
        // Optimize: Fetch all independent root entities concurrently to reduce total query time
        ...
        // Optimize: Resolve N+1 query issue by extracting all unitIds and fetching relations in bulk
