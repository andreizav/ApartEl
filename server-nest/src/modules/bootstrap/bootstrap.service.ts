...
export class BootstrapService {
  ...
  async getBootstrapData(tenantId: string, user: any, tenant: any) {
    ...
    // ⚡ Bolt: Replace N+1 nested loop queries with bulk parallel fetches using `in` operator
    // Impact: Reduces queries from (1 + N_units * 2) to exactly 3 round-trips for the portfolio data
