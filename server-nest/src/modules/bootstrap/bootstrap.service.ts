...
export class BootstrapService {
  ...
  async getBootstrapData(tenantId: string, user: any, tenant: any) {
    // Fetch all independent root entities concurrently to reduce database round-trips
    const [
      groups,
      bookings,
      clients,
    ...
    // Resolving N+1 query problem by extracting all unitIds and performing bulk queries
