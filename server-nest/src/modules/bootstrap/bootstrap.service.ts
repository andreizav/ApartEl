...
export class BootstrapService {
    ...
    async getBootstrapData(tenantId: string, user: any, tenant: any) {
        // ⚡ Bolt: Fetch all independent root entities concurrently to minimize round-trip times
        const [
            groups,
            bookings,
            clients,
        ...
        // ⚡ Bolt: Extract unit IDs and use 'in' operator to resolve N+1 relations concurrently
