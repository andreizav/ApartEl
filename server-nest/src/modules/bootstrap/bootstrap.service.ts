...
export class BootstrapService {
  ...
  async getBootstrapData(tenantId: string, user: any, tenant: any) {
    // ⚡ Bolt: Fetch multiple independent root entities concurrently to minimize database round-trip times.
    const [
      groups,
      bookings,
      clients,
    ...
    // ⚡ Bolt: Resolve N+1 queries by collecting unit IDs and using bulk queries instead of nested loops
