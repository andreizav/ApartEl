...
export class BootstrapService {
    ...
    async getBootstrapData(tenantId: string, user: any, tenant: any) {
        // ⚡ Bolt: Execute independent queries concurrently using Promise.all to reduce database round-trips
        ...
        // ⚡ Bolt: Eliminate N+1 queries by bulk fetching mappings & connections using extracted unit IDs
