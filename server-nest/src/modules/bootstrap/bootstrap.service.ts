...
export class BootstrapService {
  ...
  async getBootstrapData(tenantId: string, user: any, tenant: any) {
    // Optimize: Fetch all independent root entities concurrently using Promise.all
    const [
      groups,
      bookings,
      clients,
    ...
    // Optimize: Resolve N+1 query by collecting unitIds and querying all in a single batch
