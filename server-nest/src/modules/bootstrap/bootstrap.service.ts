...
export class BootstrapService {
  ...
  async getBootstrapData(tenantId: string, user: any, tenant: any) {
    // Execute all independent queries concurrently to minimize database round-trip latency.
    // Nested relation where filters are used to fetch channel mappings and ical connections
    // directly instead of iterating and incurring N+1 queries.
    const [
      groups,
      bookings,
      clients,
