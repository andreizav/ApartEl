...
export class BootstrapService {
  ...
  async getBootstrapData(tenantId: string, user: any, tenant: any) {
    // ⚡ Bolt Optimization: Fetch independent root entities concurrently to reduce DB round-trip latency.
    const [
      groups,
      bookings,
      clients,
    ...
    // ⚡ Bolt Optimization: Eliminate N+1 queries by collecting all unit IDs and using bulk queries.
