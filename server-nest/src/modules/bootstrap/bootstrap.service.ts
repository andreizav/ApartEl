...
export class BootstrapService {
    ...
    async getBootstrapData(tenantId: string, user: any, tenant: any) {
        ...
        // ⚡ Bolt: Optimize N+1 queries by collecting unit IDs and batch fetching
        // Expected impact: Reduces database roundtrips from O(N) to O(1) for channel mappings and ical connections
