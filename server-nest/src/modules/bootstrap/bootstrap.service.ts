...
export class BootstrapService {
    ...
    async getBootstrapData(tenantId: string, user: any, tenant: any) {
        // ⚡ Bolt Optimization: Fetch all independent root entities concurrently to minimize database round-trips
        ...
        // ⚡ Bolt Optimization: Replace nested N+1 loop with bulk extraction and parallel batch queries
