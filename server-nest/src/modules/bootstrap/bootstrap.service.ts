...
export class BootstrapService {
    ...
    async getBootstrapData(tenantId: string, user: any, tenant: any) {
        // Bolt ⚡: Run independent top-level root queries concurrently rather than sequentially
        const [
            groups,
            bookings,
            clients,
        ...
        // Bolt ⚡: Extract unit IDs and bulk fetch child entities to resolve N+1 queries in loops
