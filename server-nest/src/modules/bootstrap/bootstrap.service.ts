...
export class BootstrapService {
  ...
  async getBootstrapData(tenantId: string, user: any, tenant: any) {
    // ⚡ Bolt: Fetch multiple independent root entities concurrently to reduce DB round-trips
    const [
      groups,
      bookings,
      clients,
    ...
    // ⚡ Bolt: Collect all unit IDs from groups to fetch related data in bulk, eliminating N+1 queries
