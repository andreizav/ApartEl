...
export class BootstrapService {
    ...
    async getBootstrapData(tenantId: string, user: any, tenant: any) {
        // ⚡ Bolt: Fetch all independent root entities concurrently to minimize database round-trip times
        const [
            groups,
            bookings,
            clients,
        ...
        // ⚡ Bolt: Fix N+1 query problem by batch fetching channel mappings and ical connections
