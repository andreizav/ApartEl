...
export class BootstrapService {
  ...
  async getBootstrapData(tenantId: string, user: any, tenant: any) {
    // ⚡ Bolt: Execute independent root queries concurrently
    const [
      groups,
      bookings,
      clients,
    ...
    // ⚡ Bolt: Fix N+1 query issue for channelMappings and icalConnections
    // Extract all unit IDs and execute bulk queries
