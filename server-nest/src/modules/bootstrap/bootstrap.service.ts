...
export class BootstrapService {
    ...
    async getBootstrapData(tenantId: string, user: any, tenant: any) {
        // ⚡ Bolt: Execute independent queries concurrently to minimize database round-trip times
        const [
            groups,
            bookings,
            clients,
        ...
        // ⚡ Bolt: Fix N+1 queries by collecting all unitIds and fetching relations in batches
