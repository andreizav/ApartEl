...
export class BootstrapService {
  ...
  async getBootstrapData(tenantId: string, user: any, tenant: any) {
    // ⚡ Bolt Optimization: Fetch independent core entities concurrently
    // Impact: Reduces overall latency by parallelizing 7 sequential DB trips into 1
    const [
      groups,
      bookings,
      clients,
    ...
    // ⚡ Bolt Optimization: Eliminate N+1 loop query
    // Extracted all unit IDs to fetch related records in 2 batched queries instead of N*2
