...
export class BootstrapService {
    ...
    async getBootstrapData(tenantId: string, user: any, tenant: any) {
        // ⚡ Bolt: Fetching independent entities concurrently to eliminate sequential await bottlenecks
        ...
        // ⚡ Bolt: Batching relation queries with 'in' operator to eliminate N+1 queries in loops
