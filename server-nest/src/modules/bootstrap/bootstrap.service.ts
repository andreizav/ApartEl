...
export class BootstrapService {
  ...
  async getBootstrapData(tenantId: string, user: any, tenant: any) {
    // ⚡ Bolt: Fetch independent root entities concurrently to minimize database round-trips
    const [
      groups,
      bookings,
      clients,
    ...
    // Extract unit IDs and use a single "in" query instead of querying in a loop
