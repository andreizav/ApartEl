...
export class BootstrapService {
    ...
    async getBootstrapData(tenantId: string, user: any, tenant: any) {
        ...
        // ⚡ Bolt Optimization: Replaced O(N) sequential queries inside nested loops
        // with O(1) bulk database queries using the `in` operator and Promise.all for concurrency.
        // This eliminates the N+1 query bottleneck and significantly reduces latency.
